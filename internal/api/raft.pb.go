...
func (x *AppendEntriesResponse) GetIndex() int32 {
	if x != nil {
		return x.Index
	}
	return 0
...
const file_raft_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"raft.proto\x12\x05rafty\"*\n" +
	"\x0eProposeRequest\x12\x18\n" +
	"\acommand\x18\x01 \x01(\fR\acommand\"\x90\x01\n" +
	...
	"\acommand\x18\x03 \x01(\fR\acommand\"\xdb\x01\n" +
	...
	"\aentries\x18\x05 \x03(\v2\x0f.rafty.LogEntryR\aentries\x12\"\n" +
	"\fleaderCommit\x18\x06 \x01(\x05R\fleaderCommit\"[\n" +
	"\x15AppendEntriesResponse\x12\x12\n" +
	"\x04term\x18\x01 \x01(\x05R\x04term\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12\x14\n" +
	"\x05index\x18\x03 \x01(\x05R\x05index2\xe6\x01\n" +
	"\vRaftService\x12D\n" +
	"\vRequestVote\x12\x19.rafty.RequestVoteRequest\x1a\x1a.rafty.RequestVoteResponse\x12J\n" +
	"\rAppendEntries\x12\x1b.rafty.AppendEntriesRequest\x1a\x1c.rafty.AppendEntriesResponse\x12E\n" +
	"\x0eProposeCommand\x12\x15.rafty.ProposeRequest\x1a\x1c.rafty.AppendEntriesResponseB-Z+github.com/svfoxat/rafty/internal/api;raftyb\x06proto3"
...
var file_raft_proto_goTypes = []any{
	(*ProposeRequest)(nil),        // 0: rafty.ProposeRequest
	(*RequestVoteRequest)(nil),    // 1: rafty.RequestVoteRequest
	(*RequestVoteResponse)(nil),   // 2: rafty.RequestVoteResponse
	(*LogEntry)(nil),              // 3: rafty.LogEntry
	(*AppendEntriesRequest)(nil),  // 4: rafty.AppendEntriesRequest
	(*AppendEntriesResponse)(nil), // 5: rafty.AppendEntriesResponse
}
var file_raft_proto_depIdxs = []int32{
	3, // 0: rafty.AppendEntriesRequest.entries:type_name -> rafty.LogEntry
	1, // 1: rafty.RaftService.RequestVote:input_type -> rafty.RequestVoteRequest
	4, // 2: rafty.RaftService.AppendEntries:input_type -> rafty.AppendEntriesRequest
	0, // 3: rafty.RaftService.ProposeCommand:input_type -> rafty.ProposeRequest
	2, // 4: rafty.RaftService.RequestVote:output_type -> rafty.RequestVoteResponse
	5, // 5: rafty.RaftService.AppendEntries:output_type -> rafty.AppendEntriesResponse
	5, // 6: rafty.RaftService.ProposeCommand:output_type -> rafty.AppendEntriesResponse
